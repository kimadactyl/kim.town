...
<iframe src="/kim.town-v2/downloads/rules.pdf" width="100%" height="600px" style={{border: '1px solid #ccc', borderRadius: '8px'}}></iframe>

<DownloadButton href="/kim.town-v2/downloads/rules.pdf" filename="Rules" size="123KB" />

### Cardsheet

<iframe src="/kim.town-v2/downloads/cardsheet.pdf" width="100%" height="600px" style={{border: '1px solid #ccc', borderRadius: '8px'}}></iframe>

<DownloadButton href="/kim.town-v2/downloads/cardsheet.pdf" filename="Cardsheet" size="6.6MB" />
