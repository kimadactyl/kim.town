...
Email permanently stores the message in the sender's outbox and the recipients inbox, making a digital copy that both people can access in perpetuity. DMs, depending on implementation, either act the same as emails or only actually exist on the vendor's remote server and what both people see is a copy of this. Faxes however delete the transmission after it's happened. Despite them being possible to be sent digitally now there is no fax machine 'outbox' apart from the original document. The piece of paper it comes on is the same thing as the information transmitted, not a reproducible print off like you would do for an email.
