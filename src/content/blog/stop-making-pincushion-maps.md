...
![Map of the UK showing unidentified markers](../../assets/images/alliscalm/Screenshot-from-2015-10-12-12-09-14.png)

Clicking one of the zits gives us some context...

![Single sound entry overlaid on map](../../assets/images/alliscalm/Screenshot-from-2015-10-12-12-11-13.png)
...
![Trafford community assets map with multiple marker layers](../../assets/images/alliscalm/Screenshot-from-2015-10-12-12-16-36.png)
...
![Migration map based on the Dymaxion Projection](../../assets/images/alliscalm/18unujny2bc0wjpg.jpg)
...
![Timeline as a route visualization](../../assets/images/alliscalm/Screenshot-from-2015-10-12-13-06-13.png)

Finally, I have a real soft spot for the "map as propaganda".

![American cartoon map from 1877](../../assets/images/alliscalm/propaganda-maps.jpg)
